...
if not DATABASE_URL:
    ...
    # Normalize for URI: forward slashes are safer for SQLite URIs
    uri_path = str(db_path).replace("\\", "/")
    DATABASE_URL = f"sqlite:///{uri_path}"
else:
    # If DATABASE_URL is provided via env and it's sqlite, ensure the parent dir exists
